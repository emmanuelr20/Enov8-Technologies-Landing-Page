...
export const metadata = {
  ...
  description: "Learn about Enov8 Technologies, our vision, mission, and the core values that drive our commitment to delivering world-class digital solutions.",
};
...
const values = [
  {
    ...
    description: "We constantly explore new technologies to provide forward-thinking solutions that keep our clients ahead of the curve."
  },
  {
    title: "Quality-Driven Delivery",
    icon: <Award className="w-8 h-8 text-light-primary" />,
    description: "Excellence is our baseline. We maintain an uncompromising standard of quality in every line of code and piece of hardware."
  },
  {
      ...
      <main className="min-h-screen bg-white dark:bg-zinc-950 transition-colors duration-300">
        ...
        <div className="relative bg-[#09090b] overflow-hidden py-24 md:py-32">
          ...
          <div className="relative z-10 container mx-auto px-6 text-center max-w-4xl">
            <div className="inline-flex items-center gap-3 px-4 py-2 bg-light-primary/10 border border-light-primary/20 rounded-full mb-8">
              ...
              <span className="text-light-primary font-bold text-xs tracking-widest uppercase font-poppins">
                Company Overview
              </span>
            </div>
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold text-white tracking-tighter font-space mb-8">
              Who We Are
            </h1>
            <p className="text-gray-300 text-lg md:text-xl font-poppins leading-relaxed max-w-3xl mx-auto">
              Enov8 Technologies Ltd. is a Nigerian-based technology company delivering end-to-end digital solutions. We are a forward-thinking team united by one purpose: turning complex technology challenges into competitive advantages for our clients.
            </p>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
            ...
            <div className="space-y-8">
              <h2 className="text-3xl md:text-4xl font-black text-[#1A1A37] dark:text-white font-space tracking-tight">
                Built to Last. <span className="text-light-primary">Designed to Grow.</span>
              </h2>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              {stats.map((stat, idx) => (
                ...
                >
                  <h3 className="text-4xl font-black text-[#1A1A37] dark:text-white font-space mb-3 group-hover:text-light-primary transition-colors">
                    {stat.value}
                  </h3>
                  <p className="text-sm font-bold text-zinc-500 uppercase tracking-wide font-poppins">
                    {stat.label}
                  </p>
                </div>
              ))}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 lg:gap-20">
              ...
              <div className="bg-white dark:bg-zinc-950 p-10 lg:p-14 border-t-4 border-light-primary shadow-xl">
                <div className="w-16 h-16 bg-light-primary/10 rounded-full flex items-center justify-center mb-8">
                  <span className="text-2xl font-black text-light-primary font-space">V</span>
                </div>
                <h3 className="text-3xl font-black text-[#1A1A37] dark:text-white font-space mb-6">
                  Our Vision
                </h3>
                ...
                <div className="border-l-4 border-light-primary pl-6 py-2">
                  <p className="text-lg italic font-poppins text-zinc-500 dark:text-zinc-400">
                    "The technology your organisation needs to compete globally should not require a global budget. We are here to close that gap."
                  </p>
                </div>
              </div>
              ...
              <div className="bg-white dark:bg-zinc-950 p-10 lg:p-14 border-t-4 border-zinc-800 dark:border-white shadow-xl">
                <div className="w-16 h-16 bg-zinc-100 dark:bg-zinc-800 rounded-full flex items-center justify-center mb-8">
                  <span className="text-2xl font-black text-[#1A1A37] dark:text-white font-space">M</span>
                </div>
                <h3 className="text-3xl font-black text-[#1A1A37] dark:text-white font-space mb-6">
                  Our Mission
                </h3>
        ...
        <section className="py-20 md:py-32 container mx-auto px-6">
          <div className="text-center max-w-3xl mx-auto mb-20">
            <h2 className="text-3xl md:text-5xl font-black text-[#1A1A37] dark:text-white font-space tracking-tight mb-6">
              Our Core Values
            </h2>
            <p className="text-gray-600 dark:text-gray-400 text-lg font-poppins">
              The foundational principles that guide our decisions, shape our culture, and define how we partner with our clients.
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {values.map((value, idx) => (
              <div key={idx} className="group p-8 border border-zinc-100 dark:border-zinc-800 hover:border-light-primary/30 bg-white dark:bg-zinc-950">
                ...
                <p className="text-gray-600 dark:text-gray-400 font-poppins leading-relaxed">
                  {value.description}
                </p>
              </div>
            ))}
